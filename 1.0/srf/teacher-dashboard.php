...
?>
            ...
            <div class="content-wrapper">
                <div class="content-container">
                    ...
                    <?php include('teacher-dashboard-leftbar.php');?>  
...
?> <span class="bg-icon"><i class="fa fa-file-text"></i></span>
                                            ...
                                            <span class="name">No. Students Results</span>
                                        ...
                                        <?php } ?>
                                            <div class="panel-body p-20">
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
<?php $sql = "SELECT  distinct tblstudents.StudentName,tblstudents.RollId,tblstudents.RegDate,tblstudents.StudentId,tblstudents.Status,tblclasses.ClassName,tblclasses.Section,tblterms.term,tblterms.id,tblsemesters.semester,tblsemesters.id,tblyear.year,tblyear.id from tblresult join tblstudents on tblstudents.StudentId=tblresult.StudentId  
join tblclasses on tblclasses.id=tblresult.ClassId 
join tblterms on tblterms.id=tblresult.TermId
join tblsemesters on tblsemesters.id=tblresult.SemesterId
join tblyear on tblyear.id=tblresult.YearId
";
